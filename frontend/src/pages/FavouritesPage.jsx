...
const FavoritesPage = () => {
  ...
  // Helper to pick image from normalized backend response
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold gradient-text-mal mb-2">Most Favorited Anime</h1>
          <p className="text-gray-400">The most favorited anime by fans worldwide</p>
        </div>
                ...
                <div className="bg-gray-800 rounded-lg overflow-hidden transition-all group-hover:scale-105 group-hover:shadow-2xl">
                  <div className="relative">
                    ...
                    <div className="absolute top-2 right-2 bg-black/70 px-2 py-1 rounded text-xs">
                      ❤️ {anime.Favorites?.toLocaleString() ?? "N/A"}
                    </div>
                  </div>
